...
CommodityFixedLegData::CommodityFixedLegData()
    : ore::data::LegAdditionalData(LegType::CommodityFixed),
...
CommodityFixedLegData::CommodityFixedLegData(const vector<Real>& quantities, const vector<string>& quantityDates,
    ...
    : LegAdditionalData(LegType::CommodityFixed), quantities_(quantities), quantityDates_(quantityDates),
...
CommodityFloatingLegData::CommodityFloatingLegData()
    : ore::data::LegAdditionalData(LegType::CommodityFloating),
...
CommodityFloatingLegData::CommodityFloatingLegData(
    ...
    : LegAdditionalData(LegType::CommodityFloating), name_(name), priceType_(priceType), quantities_(quantities),
