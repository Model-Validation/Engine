...
%      \emph{AED, AOA, ARS, ATS, AUD, BEF, BGN, BHD,
...
% hard coded and configured currencies:
\emph{AED,AFN,ALL,AMD,ANG,AOA,ARS,AUD,AWG,AZN,
...
VES,VND,VUV,WST,XAF,XAG,XAU,XCD,XOF,XPD,
XPF,XPT,XSU,XUA,YER,ZAR,ZMW,ZWL.}
This full list of currencies is available via loading the provided {\tt currencies.xml} at start-up.
